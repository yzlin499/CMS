...
public class WeChatJSUtil {
    ...
    private void updateToken(){
        JSONObject result=JSONObject.fromObject(NetTools.sendGet(W.ApiUrl.AccessToken,
    ...
    private void updateJSTicket(){
        JSONObject result=JSONObject.fromObject(NetTools.sendGet(W.ApiUrl.GetTicket,
