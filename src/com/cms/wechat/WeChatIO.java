...
public class WeChatIO<T extends WCInfo> {
    ...
    private static Logger logger=Logger.getLogger(WeChatIO.class);
    private static WeChatFromIDPool idPool=WeChatFromIDPool.getInstance();
...
//            logger.warn(inputXml);
            ...
            Class wcI=Class.forName("com.cms.infobeans.wechat."+type);
            wcInfo=(WCInfo) InstanceByMap.createInstance(wcI,map);
